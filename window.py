...
sft5f = CosWindowFunction(
    [0.1881, -.36923, .28702, 0.13077, .02488], .75, 'sft5f')
sft3m = CosWindowFunction([0.28235, -.52105, .19659], .721, 'sft3m')
sft4m = CosWindowFunction([.241906, -.460841, .255381, -.041872], .785, 'sft4m')
sft5m = CosWindowFunction(
    [.209671, -.407331, .281225, -.092669, .0091036], .76, 'sft5m')
hft90d = CosWindowFunction(
    [1, -1.942604, 1.340318, -.440811, .043097], .76, 'hft90d')
hft95 = CosWindowFunction(
    [1, -1.9383379, 1.3045202, -.4028270, .0350665], .756, 'hft95')
...
hft169d = CosWindowFunction([1, -
                             1.97441842, 1.65409888, -
                             0.95788186, 0.33673420, -
                             0.06364621, 0.00521942, -
                             0.00010599], .812, 'hft169d')
hft248d = CosWindowFunction([1, -
                             1.985844164102, 1.791176438506, -
                             1.282075284005, 0.667777530266, -
                             0.240160796576, 0.056656381764, -
                             0.008134974479, 0.000624544650, -
                             0.000019808998, 0.000000132974], .841, 'hft248d')
nutall4 = CosWindowFunction([.3125, -.46875, .1875, -.03125], .704, 'nutall4')
flattop = CosWindowFunction(
    [0.2156, -0.4160, 0.2781, -0.0836, 0.0069], .75, 'flattop')
hanning = CosWindowFunction([0.5, -0.5], .5, 'hanning')
hamming = CosWindowFunction([0.54, -0.46], .5, 'hamming')
blackmanharris = CosWindowFunction(
    [0.35875, -0.48829, 0.14128, -0.01168], .661, 'blackman-harris')
